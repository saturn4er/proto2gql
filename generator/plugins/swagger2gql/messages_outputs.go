...
func (g *Plugin) outputMessageGraphQLName(messageFile *parsedFile, message *parser.Message) string {
	return messageFile.Config.GetGQLMessagePrefix() + strings.Join(message.TypeName, "__")
}
func (g *Plugin) outputMessageVariable(messageFile *parsedFile, message *parser.Message) string {
	return messageFile.Config.GetGQLMessagePrefix() + strings.Join(message.TypeName, "")
}

func (g *Plugin) outputMessageTypeResolver(messageFile *parsedFile, message *parser.Message) (graphql.TypeResolver, error) {
...
func (g *Plugin) outputMessageFields(file *parsedFile, msg *parser.Message) ([]graphql.ObjectField, error) {
...
func (g *Plugin) outputMessageMapFields(file *parsedFile, msg *parser.Message) ([]graphql.ObjectField, error) {
	var res []graphql.ObjectField
