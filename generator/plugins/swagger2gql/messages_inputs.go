...
func (g *Plugin) inputMessageGraphQLName(file *parsedFile, message *parser.Message) string {
	return file.Config.GetGQLMessagePrefix() + strings.Join(message.TypeName, "__") + "Input"
}
func (g *Plugin) inputMessageVariable(msgFile *parsedFile, message *parser.Message) string {
	return msgFile.Config.GetGQLMessagePrefix() + strings.Join(message.TypeName, "") + "Input"
}

func (g *Plugin) inputMessageTypeResolver(msgFile *parsedFile, message *parser.Message) (graphql.TypeResolver, error) {
