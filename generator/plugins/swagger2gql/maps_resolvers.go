...
func (g *Plugin) mapResolverFunctionName(mapFile *parsedFile, mp *parser.Map) string {
	return "Resolve" + g.inputMapVariable(mapFile, mp)
}
func (g *Plugin) fileInputMapResolvers(file *parsedFile) ([]graphql.MapInputObjectResolver, error) {
