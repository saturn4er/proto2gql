...
// func (g Swagger2GraphQL) SchemaServices() []schema.Service {
...
// 	return res
// }
func (g Swagger2GraphQL) serviceMethodArguments(cfg MethodConfig, method *parser.Method) ([]graphql.MethodArgument, error) {
...
func (g Swagger2GraphQL) messagePayloadErrorParams(message *parser.Message) (checker graphql.PayloadErrorChecker, accessor graphql.PayloadErrorAccessor, err error) {
...
func (g Swagger2GraphQL) methodName(cfg MethodConfig, method *parser.Method) string {
	if cfg.Alias != "" {
		return cfg.Alias
	}
	return method.Name
}
func (g Swagger2GraphQL) serviceMethod(cfg MethodConfig, file *parsedFile, method *parser.Method) (*graphql.Method, error) {
...
func (g Swagger2GraphQL) serviceQueryMethods(sc ServiceConfig, file *parsedFile, service *parser.Service) ([]graphql.Method, error) {
...
func (g Swagger2GraphQL) methodIsQuery(cfg MethodConfig, method *parser.Method) bool {
	return !strings.HasPrefix(strings.ToLower(method.Name), "get")
}
func (g Swagger2GraphQL) serviceMutationsMethods(cfg ServiceConfig, file *parsedFile, service *parser.Service) ([]graphql.Method, error) {
	var res []graphql.Method
	for _, method := range service.Methods {
...
func (g Swagger2GraphQL) methodIsMutation(cfg MethodConfig, method *parser.Method) bool {
	return strings.HasPrefix(strings.ToLower(method.Name), "get")
}
func (g Swagger2GraphQL) serviceQueryName(sc ServiceConfig, service *parser.Service) string {
	if sc.Alias != "" {
		return sc.Alias
	}
	return service.Name
}
func (g Swagger2GraphQL) serviceMutationName(sc ServiceConfig, service *parser.Service) string {
	if sc.Alias != "" {
		return sc.Alias + "Mutations"
	}
	return service.Name + "Mutations"
}
func (g Swagger2GraphQL) fileServices(file *parsedFile) ([]graphql.Service, error) {
