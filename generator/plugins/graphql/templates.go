...
func templatesSchemas_bodyGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/schemas_body.gohtml", size: 1599, mode: os.FileMode(420), modTime: time.Unix(1531309982, 0)}
...
func templatesSchemas_headGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/schemas_head.gohtml", size: 192, mode: os.FileMode(420), modTime: time.Unix(1530882049, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
