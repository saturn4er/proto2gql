...
func ResolveRootMessage(ctx context.Context, i interface{}) (_ *testdata.RootMessage, rerr error) {
	...
	//Generated oneoff
	if e_f_o_e_, ok := args["e_f_o_e"]; ok && e_f_o_e_ != nil { // Non-repeated enum
	...
	if s_f_o_s_, ok := args["s_f_o_s"]; ok && s_f_o_s_ != nil { // Non-repeated scalar
	...
	if m_f_o_m_, ok := args["m_f_o_m"]; ok && m_f_o_m_ != nil { // Non-repeated message
	...
	if em_f_o_em_, ok := args["em_f_o_em"]; ok && em_f_o_em_ != nil { // Non-repeated message
